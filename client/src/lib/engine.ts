...
/**
 * PEIXEIRO RAIZ - MOTOR DE CÁLCULO (VERSÃO 1.0)
 * 
 * Este motor replica fielmente a lógica da planilha "Planilha Criador Inteligente - Final.xlsx".
 * Os cálculos são executados localmente para garantir funcionamento offline.
 */
